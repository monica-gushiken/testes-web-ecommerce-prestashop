...
public class ProdutoPage {
	...
	public void selecionarOpcaoDropdown(String opcao) {
		encontrarDropdownTamanho().selectByVisibleText(opcao);
	}

	public List<String> obterOpcoesSelecionadas() {
		List<WebElement> elementosSelecionados = encontrarDropdownTamanho().getAllSelectedOptions();
	...
	public Select encontrarDropdownTamanho() {
